...
function ListPokemons({allPokemons, search, gen, setLanguage, language, selectedTypes, setSelectedTypes, Pokemons}) {
        ...
        <div>
            <div id='listPoke'>
                <div>
                    ...
                    <SelectMultiple options={Types} selected={setSelectedTypes} selectedTypes={selectedTypes} />               
                    <div>
                ...
                <div>
                    {allPokemons.length > 0 ? allPokemons.map((element, i) => (                    
                        <div key={i} className={element.types[0].name}>
                            <div>
                                <h1>#{element.pokedex_id} {element.name[language]}</h1>
                                <div>
            ...
            {openModal && <Modal closeModal={setOpenModal} pokemon={onePokemon} language={language} allPokemons={Pokemons}/>}
        </div>
    );
}
